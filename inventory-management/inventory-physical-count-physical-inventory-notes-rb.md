---
title: "Inventory Physical Count Physical Inventory Notes Rb"
source: "inventory-physical-count-physical-inventory-notes-rb.md"
tags: ['SM3', 'Inventory Management']
version: "1.0"
last_updated: "2026-02-19"
short_description: "Inventory Physical Count Physical Inventory Notes Rb"
long_description: "This document provides detailed information about inventory physical count physical inventory notes rb in the 4GL system. It includes procedures, reference information, and best practices for users and administrators."
---
...
-   **Manual Entry** (if not using Handheld):
    -   New Log "N" in the log field.
    -   Fields: chg, length, locat., weight, PC.
-   **Handheld (HH) Entry**: `WF15`

> **Note: During Inventory Count**
> -   **SO can be entered.**
> -   **PO can be entered.**
