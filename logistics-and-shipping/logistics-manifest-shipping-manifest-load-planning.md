...
short_description: "A guide to the Manifest and Load Planning features within the 4GL Solutions 4GL software. It covers creating and managing 'runs' for outbound trucks, assigning documents and materials, and the overall workflow from retrieving documents to final shipment processing."
...
4GL ensures that the loaded material coincides with what was physically picked against a particular run.
