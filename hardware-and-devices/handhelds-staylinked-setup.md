...
- Now the da1 user has been successfully added in StayLinked and the 4GL server. Additionally, the login script has been saved and the users can simply scan the barcodes andthe handheld will translate the barcodeto the appropriate commands.
Troubleshooting
