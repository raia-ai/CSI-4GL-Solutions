...
**Description: **This document provides a foundational overview of metal classifications, shapes, finishes, grades, and ASTM specifications. It is intended to assist in understanding what data structures and fields may be needed in SM3 for comprehensive support of the metal industry.
