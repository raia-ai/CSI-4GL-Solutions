---
title: "Sales Costing Average Vs Actual Method Based On Product Line And Individual Product Level"
source: "Sales-Costing_Average_vs_Actual_method_based_on_Product_Line_and_Individual_Product_Level.md"
tags: ["4GL", "Sales and Order Entry"]
version: "1.0"
last_updated: "2026-02-19"
short_description: "Sales Costing Average Vs Actual Method Based On Product Line And Individual Product Level"
long_description: "This document provides detailed information about sales costing average vs actual method based on product line and individual product level in the 4GL system."
---
...
tags: ["Costing Method", "Average Costing", "Actual Costing", "Inventory", "Product Line", "Product Level", "IN16", "IN1ZC", "IN92", "SM3"]
version: "1.0"
...
Let me break this down in two parts to help clarify how costing methods are handled in the system:

## 1. Product Line Level

You can check the default costing method set for a product line by following these steps:
...
The screenshot below shows the `Product Line Options` window in the `SM3 Product Line` screen (`IN16`), where the **Costing Method** is set to `Average` for the `ASH` product line.
