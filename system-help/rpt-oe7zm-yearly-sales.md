---
title: "OE7ZM - Yearly Sales\_By Customer"
source: madcap.md
version: '1.0'
last_updated: '2026-02-19'
short_description: "OE7ZM - Yearly Sales\_By Customer"
long_description: "Help documentation for OE7ZM - Yearly Sales\_By Customer in the 4GL system."
---
...
2. Enter or select Customer Start Date (customers with a start date after this date will be included).
3. Enter or select a Territory code (by default, if “ALL” is selected the Province/State and Operator fields will default to “ALL”).
4. Enter or select a Province/State (by default, all are selected).
