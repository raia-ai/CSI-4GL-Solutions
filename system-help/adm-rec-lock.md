...
The Record Locks form displays two types of files in use: the top table displays Oracle tables and the bottom table displays files. The _Primary Key_ column displays the key of the record that is locked — typically the warehouse and document number.
