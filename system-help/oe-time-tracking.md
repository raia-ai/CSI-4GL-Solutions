...
long_description: >-
  Help documentation for Tracking Processing Time for an Order or Nesting
  Project in the 4GL system.
---
...
1. Expand the Sales Price field for a line item – there will be an M line with the Estimated time calculated based on the order qty, product, and machine process selected. This time can be overwritten.
