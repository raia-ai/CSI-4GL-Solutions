...
short_description: Receiving Confirmation
long_description: Help documentation for Receiving Confirmation in the 4GL system.
---
...
When you process, lines with status 1 will set the received flag to “Y” and the processed receipt will be sent to Task Manager for approval. Any lines with error status 2-4 will generate a receipt confirmation error and an investigation task will be created in Task Manager.
...
* The Receipt Confirmation # (RF) is printed on the Receipt Report and displayed on the Receipt Inquiry screen (PO62).
