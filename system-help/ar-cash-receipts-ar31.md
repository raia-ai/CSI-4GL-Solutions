---
title: Recording Cash Receipts
source: madcap.md
version: '1.0'
last_updated: '2026-02-19'
short_description: Recording Cash Receipts
long_description: Help documentation for Recording Cash Receipts in the 4GL system.
---
...
2. To open an existing document, enter the Deposit Number on the left, or select from the list on the right.\
   To create a new deposit document, enter “N” in the Deposit Number field on the left, or click New.
3. On the Header tab, enter overall information about the document:
...
4.  On the Details tab, enter details of the deposit. This can comprise multiple lines, e.g. multiple checks:
...
5. Repeat as necessary to record additional payments for the same deposit.
6.
   * . You can view the deposit in Cash Receipt Inquiry.
