...
long_description: Help documentation for Entering Quotes and Orders in the 4GL system.
---
...
3.  On the Billing/Shipping tab:
    ...
    * _Orders:_ Optionally enter an Invoice Date if agreed upon with the customer.
...
6.  The Details tab is where you identify what is included on the order. Here you can:
    ...
    * Nest - nest selected line items, or import line items into a new sales order and nest them at the same time.
    ...
    Click  to access additional buttons.
...
10.
    * If a contact is specified to receive an email (on the Contacts tab), you can edit the subject and message for this order.
    *
