...
1. Enable the Client for NFS service:
   1. Go to Control Panel > Programs > Turn Windows features on or off.<br>
   2. Scroll down until you see “Services for NFS”. Make sure this is enabled along with “Client for NFS”. The Administrative Tools do not need to be enabled.<br>
2. Edit the registry:
   ...
   3. Repeat to add a second DWORD32 registry entry named “AnonymousUid” with a value of 0.<br>
...
4. Map the network drive:
   ...
   3. Type the folder path.\
      \*\* Keep in mind linux uses this **/** for a backslash but on windows it is a \*_\*_\
      Make sure you use this \*_\*_ on this screen \*\*
