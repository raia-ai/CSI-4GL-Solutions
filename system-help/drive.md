...
1. Enable the Client for NFS service:
   1. Go to Control Panel > Programs > Turn Windows features on or off.\
      [![](https://4glsol.com/sm3-helpdocs/Content/Resources/Images/map-drive1.png)](https://4glsol.com/sm3-helpdocs/Content/Resources/Images/map-drive1.png)
   2. Scroll down until you see “Services for NFS”. Make sure this is enabled along with “Client for NFS”. The Administrative Tools do not need to be enabled.\
      [![](https://4glsol.com/sm3-helpdocs/Content/Resources/Images/map-drive2.png)](https://4glsol.com/sm3-helpdocs/Content/Resources/Images/map-drive2.png)
2. Edit the registry:
   ...
   3. Repeat to add a second DWORD32 registry entry named “AnonymousUid” with a value of 0.\
      [![](https://4glsol.com/sm3-helpdocs/Content/Resources/Images/map-drive3.png)](https://4glsol.com/sm3-helpdocs/Content/Resources/Images/map-drive3.png)
...
4. Map the network drive:
   ...
   2. Assign the letter for the drive. The letter should be the same on all computers and in SM3 (Z used as example).
   ...
   4.  Click Finish. This process can take just over a minute.
       ...
       [![](https://4glsol.com/sm3-helpdocs/Content/Resources/Images/map-drive4.png)](https://4glsol.com/sm3-helpdocs/Content/Resources/Images/map-drive4.png)
