...
long_description: >-
  Help documentation for Setting Up Automatic Interest Charges in the 4GL
  system.
---
...
2. Enter or select the fiscal Period for which to charge interest.
3. If you want to apply interest to all customers with overdue balances, enter “Y” in the Set Default? field.
...
4. When you exit the window, creates a journal entry for each charge.
