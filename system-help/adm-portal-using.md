...
1.  Display the product list:
    ...
    * Scroll the Product line list, or type a few letters to see lines that match your entry:
    ...
    Click  to view your list of favorites.
2. Filter the product list:
   ...
   * To view the inventory info for a product, click . This displays all logs/bundles; if a log has an accompanying mill cert, the icon will be blue; click it to view the PDF.
3.  Select the products you want:
    ...
    * Enter either the number of Lengths/Pieces or the Quantity required. Depending on the product:
      ...
      * To override the product behavior (i.e. entering Pieces, Quantity, or logs), click  to create a Custom Cut. You are prompted to enter a description. Any logs that were preselected will be cleared. No price will be issued for this product.
    ...
    * Select the Pricing Unit that you want to be quoted.
    ...
    If this is a product you frequently order, click  to add it to your list of favorites.

    * Click  to add it to the shopping cart.
    * Repeat to add other products.
4. Review your shopping cart and finalize the quote:
   * The Cart icon reflects the number of products added; hover over the icon to view the items added.&#x20;
...
To copy an existing quote, click . If the original quote is not expired all the lines will be copied and repriced (freeze lines will not be repriced). If the original quote is expired any freeze lines will be unfrozen and repriced.

### Modifying a Quote

To change or remove items or add new items, click .
...
To view the inventory info for a product, click . If this icon is green, one or more logs have been selected for the product; in this case if you click in the Lengths/Pieces or Quantity field, you will be prompted to select from the available logs.
...
You can also view the mill info for a product on the Create Quotes page: click  beside a product to see all logs; if a log has an accompanying mill cert, the icon will be blue; click it to view the PDF.
