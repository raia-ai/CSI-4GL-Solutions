...
4. Enter or select the Product Line code (by default, all are selected).
5. Enter or select the Spec Type code (by default, all are selected).
6. Enter or select Specification code (field defaults to ALL if Spec Type is ALL).
