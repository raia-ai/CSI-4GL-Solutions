---
title: Installing the PROIV Client
source: madcap.md
version: '1.0'
last_updated: '2026-02-19'
short_description: Installing the PROIV Client
long_description: Help documentation for Installing the PROIV Client in the 4GL system.
---
...
Next you need to populate the SM3.piv file installed on your desktop with the necessary configuration information for your account.

1. Click the SM3.piv file on your desktop. The following screen opens:
...
5. Click the save button  in the menu bar, or choose Session » Save.
6. **\*\* Before logging in, complete the Windows Security Setup below.**
7. Click the yellow lightning bolt  to start a session to ensure connection to the server.
...
4. On the Security tab, click Edit. In the _Group or User names_ section click “Users”, then select “Allow” beside “Full control”. All of the Allow check boxes will be selected. Click Apply.
...
1. Click the SM3.piv file on your desktop to open PROIV.
