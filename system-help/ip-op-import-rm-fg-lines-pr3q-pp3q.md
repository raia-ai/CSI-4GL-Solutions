---
title: Importing Raw Material and Finished Goods Lines
source: madcap.md
version: '1.0'
last_updated: '2026-02-19'
short_description: Importing Raw Material and Finished Goods Lines
long_description: >-
  Help documentation for Importing Raw Material and Finished Goods Lines in the
  4GL system.
---
...
4. Open the IP document that you want to import the lines into. On the Details tab, click the down arrow  in the bottom right of the screen to get to the Excel Import button. Retrieve the appropriate spreadsheet and click Save. All the line items from the spreadsheet are added to the document Details.
