...
long_description: >-
  Help documentation for OE7AA - Sales & Profits By Salesperson Summary in the
  4GL system.
---
...
2. Indicate whether to group report by Inside salesperson, Outside salesperson or order Writer.
3. Enter or select a Salesperson code (defaults to all).
4. Enter or select the Date to which information will be included in the report (defaults to today’s date).
