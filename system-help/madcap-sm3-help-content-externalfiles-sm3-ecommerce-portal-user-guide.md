---
title: "Madcap   Sm3 Help Content Externalfiles Sm3 Ecommerce Portal User Guide"
source: "Madcap_-_SM3_Help-Content-ExternalFiles-SM3_eCommerce_Portal_User_Guide.md"
tags: ["4GL", "System Help"]
version: "1.0"
last_updated: "2026-02-19"
short_description: "Madcap   Sm3 Help Content Externalfiles Sm3 Ecommerce Portal User Guide"
long_description: "This document provides detailed information about madcap   sm3 help content externalfiles sm3 ecommerce portal user guide in the 4GL system."
---
...
tags: ["SM3", "eCommerce", "User Guide", "Steel Manager", "4GL Solutions", "Quote", "Order", "Portal", "Metal Industry"]
version: "1.0"
last_updated: "2025-12-04"
short_description: "A user guide for the SM3 eCommerce Portal, providing instructions for creating quotes, managing orders, viewing invoices, and accessing mill certificates. This guide is intended for customers of 4GL Solutions using the Steel Manager III platform."
long_description: "This document is the comprehensive SM3 eCommerce Portal User Guide, created by 4GL Solutions for users of their Steel Manager III (SM3) software. It details the step-by-step processes for interacting with the eCommerce portal, designed specifically for the metal industry. The guide covers essential functions such as creating a new quote by selecting products, filtering inventory, and specifying quantities. It also explains how to view, edit, copy, and convert existing quotes into sales orders. The document further provides instructions on monitoring sales orders, viewing proofs of delivery, accessing invoices, and retrieving mill certificates. Illustrated with screenshots and clear instructions, this guide serves as a primary reference for customers to efficiently manage their procurement and documentation needs through the SM3 online platform."
---

# SM3 eCommerce Portal User Guide

**SM3 STEEL MANAGER III | 4GL Solutions TECHNOLOGY FOR THE METAL INDUSTRY**
...
This document contains instructions for using the SM3 eCommerce Portal.
...
- **Mail Icon:** Email the quote to yourself.
- **View Icon (Magnifying Glass):** View a PDF of the quote.
- **Details Icon (List):** View the status of a quote (any lines waiting to be priced by the salesperson, the estimated arrival date of incoming material); or copy the quote.
...
- **Contacts Column:** Click the name to send an email to the salesperson.
- **Mail Icon:** Email the order to yourself.
- **View Icon (Magnifying Glass):** View a PDF of the order.
...
- **Email Sales Column:** Click the name to send an email to the salesperson.
- **Mail Icon:** Email the invoice to yourself.
- **View Icon (Magnifying Glass):** View a PDF of the invoice.
