...
5. Indicate
6. Indicate if you want aging calculated by **I**nvoice or **D**ue date.
7. Select whether to Sort By Currency, Salesperson or Territory.\
   If you entered “S”, select the Salesperson Type to include (**I**nside or **O**utside).
8. Indicate if you want to show Customer Details and Remarks.
