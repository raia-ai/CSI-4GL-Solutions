---
title: About Point of Sale (POS) Orders
source: madcap.md
version: '1.0'
last_updated: '2026-02-19'
short_description: About Point of Sale (POS) Orders
long_description: Help documentation for About Point of Sale (POS) Orders in the 4GL system.
---
...
3. An order is identified as a POS order by the payment term selected. If a POS payment term is selected on the order, you can capture payments on the Payment tab. Payments can also be entered in the standalone Payment Entry form (OE5C).
4. At the end of the day, run the POS Payment Report (OE7XV) to view and reconcile unposted payments for all customers, then run the Payment Posting form (OE5D or OE5DA) to post the payments and process the cash receipts in AR31.
