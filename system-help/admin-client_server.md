...
short_description: "Client Server - 4GL Help Documentation"
long_description: "This topic provides detailed information about Client Server in the 4GL system. It includes step-by-step procedures, reference information, and best practices for using this functionality within the ADMIN module."
---
...
To download reports to Excel, Excel 2000 or higher is required.

Workstations must have an Ethernet card installed (on the motherboard or as a separate card) to connect the workstation to a network that has the Linux server installed.
