...
short_description: Data Entry Tips
long_description: Help documentation for Data Entry Tips in the 4GL system.
---

# Data Entry Tips

* Accelerator keys are underscored letters on tabs and buttons that serve as shortcuts to invoke a command or action without having to tab to it or use your mouse to click on it. Pressing Alt+the letter is the same as clicking on the button or tab; for example, if you're on the Billing tab of a sales order, you can press Alt+U to attach a document without having to navigate down to the Document button:<br>
...
* lists that have a  at the bottom right - click this icon to restore the default columns if you have resized or rearranged columns
...
| F6  | Change / Select   | In paging screens, pressing while on sequence number (Seq) of a line will select it for changing. In select windows, pressing will select the line you are on and return data from it to previous screen.                                                     |
| F7  | Delete            | Pressing while on a line in a paging screen will select it for deletion. You can then use the up and down arrow keys to select additional lines. Once you have selected all the lines you would like to delete, the system will open confirmation window.     |
| F8  | Lookup            | Lookup mode.                                                                                                                                                                                                                                                  |
| F9  | Expand / Contract | Some paging screens have “hidden” details for each line. Press (or click at the bottom right) to view these additional details. Press again (or click ) to hide the details.                                                                                  |
...
3. On both the Numbers and Currency tabs, change the Decimal symbol to a period.<br>
