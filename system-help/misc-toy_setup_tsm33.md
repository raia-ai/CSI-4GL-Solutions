---
title: "Toy Setup Tsm33"
source: "madcap.md"
tags: ["4GL", "MISC", "Help Documentation"]
version: "1.0"
last_updated: "2026-02-19"
short_description: "Toy Setup Tsm33 - 4GL Help Documentation"
long_description: "This topic provides detailed information about Toy Setup Tsm33 in the 4GL system. It includes step-by-step procedures, reference information, and best practices for using this functionality within the MISC module."
---
...
3. Select the Product Lines that will be loaded into the system, and select the check box next to each to activate.
4. In the Shared Location field, enter the directory where all transactions will be stored/retrieved.
...
5. In the Item Number field, enter 'ALL' or a specific product.
6. Click in the OK field then click Process.
