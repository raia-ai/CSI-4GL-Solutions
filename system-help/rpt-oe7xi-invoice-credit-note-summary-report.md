...
long_description: >-
  Help documentation for OE7XI - Invoice/Credit Summary (Tax Breakdown) in the
  4GL system.
---
...
3. Enter or select the Type of Entry to report on: CM = credit memo, DM = debit memo, IV = invoice, defaults to all.
4. Indicate the Invoice Types you want to run the report for: SHP = all shipped but not invoiced, UPD = invoiced sales but not yet paid (default), ALL = all invoices.
5. Indicate if you want to sort documents by Salesperson or Order Writer.
6. Enter “Y” if you want credit and debit notes to reference the corresponding invoice date, otherwise enter “N”.
