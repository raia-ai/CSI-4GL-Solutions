...
4. Optionally enter or select a Customer to only view invoices from that customer.
5. Optionally, select a Payment Term to report on (defaults to all).
6. Indicate if you want to sort documents by Salesperson or Order Writer.
7. Indicate if you want to sort the report by: Document Number, Date, Operator, or View detail Lines.
