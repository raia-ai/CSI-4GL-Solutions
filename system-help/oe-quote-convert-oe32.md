...
long_description: Help documentation for Converting a Quote to a Sales Order in the 4GL system.
---
...
4. Optionally, click  to add additional quotes to be included in the new sales order.
...
“If using an “A” Line (reserve against incoming material) in Quote details , option to select incoming document to reserve against by press in “+” (D for details) to open Order Details window – operator can change details (modify, add, delete) in this screen.\
