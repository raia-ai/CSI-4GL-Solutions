...
* _Type_ -  indicates on-hand inventory,  indicates that the plate has dog-legs \[true?]\(click Legs to view the legs that have been entered against the plate).
* &#x20;or  in the following columns:
...
Click  to filter the list to logs of specific dimensions.\
...
5  > Warehouse > Calc Used Qty Proportionally
