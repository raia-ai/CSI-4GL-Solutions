...
long_description: Help documentation for Repricing Order Lines in the 4GL system.
---
...
1. To access the Reprice window: on the Details tab of an order or quote, click the green down arrow  in the bottom right corner to display the additional buttons, then click Re-Price.
