...
2. Enter or select Deposit Number (defaults to all).
3. Enter or select Fiscal Period (defaults to all).
4. Enter the Start Date and Ending Date for the deposit transactions to be included in the report.
5. Select the Payment Type (defaults to all types).
6. Indicate if you want to include Only Posted receipts or leave blank to exclude them.
