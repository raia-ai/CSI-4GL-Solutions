...
2. Enter or select Type Of Entry: PO = purchase order, PQ = PO quotation (typically used for intercompany inventory transfers).
3. Enter Document number or New or Duplicate.
4. The Costing window opens2 \[confirm when this happens]
5. Enter or select Order Number.
6. \*Function goes in depth through many tabs
