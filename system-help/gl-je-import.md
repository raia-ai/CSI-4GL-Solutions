...
long_description: Help documentation for Importing Journal Entries in the 4GL system.
---
...
2.  In the spreadsheet, populate the header fields and a line for each journal entry (account no., amount, description, quantity).
    ...
    **Note** - Ensure that there are no blank rows between journal entries. Do not include any commas or $ signs.
