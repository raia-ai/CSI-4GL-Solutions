...
source: "accounting-ap-accounts-payable-accounting-module-bullet-points-rev-dec-2020.md"
tags: ['SM3', 'Accounting']
version: "1.0"
...
[Image: Customer File Maintenance screen in 4GL showing details for "AAA SERVICE", including address, contact info, credit group, and payment terms.]
...
[Image: Account Changes Tracking Screen in 4GL, showing a change to the "CREDIT LINE" for customer "AAA SERVICE" from an old value of 5000 to a new value of 9000.]
...
[Image: SM3 Task Manager screen showing a list of tasks, specifically highlighting "Orders Req. Credit Approval" with details on the account, document, and reason for the credit hold.]
...
[Image: Customer AR Inquiry screen in 4GL for "ABC STAINLESS", displaying comprehensive credit information including AR balance, credit limit, available credit, aging details, and a list of A/R documents.]
...
### Payments
Payments can be received by check, post-dated check, electronic funds transfer, credit card and cash. Miscellaneous checks can also be entered for non-accounts receivable accounts. During the entry process it will be possible to apply amounts to specific outstanding documents or to post it "on account" if the document is not specified at the time. Once all entries have been entered and balanced, they can then be processed into the AR file. A deposit slip report can be printed as a back-up (figure 10.3).

**Figure 10.3: Cash Receipt Entry**
[Image: Cash Receipt Entry screen in 4GL showing a cash receipt document with a check listing for "KING STEEL", including check numbers and amounts.]
...
[Image: Purchase Variance Inquiry screen in 4GL, showing a list of purchase order receipts with their estimated vs. actual costs and the resulting variance.]
